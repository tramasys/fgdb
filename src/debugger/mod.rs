...
pub use model::{
    ...
    compare_thread_ids, current_frame, current_source, evaluated_value, executable_source_lines,
    ...
    source_files, source_locations, stack_frames, thread_group_argument, thread_id_argument,
    threads, variable_children, variable_children_have_more, variable_object,
    variable_path_expression, variable_update_named, variables,
};
